...
/* <AR0009UD8C added by leijianfeng/lwx468900 20180118 begin */
...
int catch_unexpected_exit(int exit_code)
{
	...
	if (die_catch_flags & EXIT_CATCH_FLAG) {
		pr_warn("note: %s[%d] exited with exit_code %d\n",
...
#endif
/* AR0009UD8C added by leijianfeng/lwx468900 20180118 end> */
...
{
/* <AR0009UD8C modified by leijianfeng/lwx468900 20180118 begin */
#ifdef CONFIG_HW_DIE_CATCH
	...
	do_group_exit((error_code & 0xff) << 8);
#endif
/* AR0009UD8C modified by leijianfeng/lwx468900 20180118 end> */
	/* NOTREACHED */
	return 0;
}
