...
int charger_dev_set_dpm(struct charger_device *charger_dev, unsigned char dpmbyte)
{
	if (charger_dev != NULL && charger_dev->ops != NULL && charger_dev->ops->set_dpm)
		return charger_dev->ops->set_dpm(charger_dev, dpmbyte);
...
int charger_dev_init(struct charger_device *charger_dev)
{
	if (charger_dev != NULL && charger_dev->ops != NULL && charger_dev->ops->charger_init)
		return charger_dev->ops->charger_init(charger_dev);

	return -ENOTSUPP;
}
EXPORT_SYMBOL(charger_dev_init);
...
int charger_dev_set_hz_mode(struct charger_device *charger_dev, int en)
{
