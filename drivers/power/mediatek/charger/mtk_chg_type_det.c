...
extern struct charger_manager *get_charger_manager_info(void);
	...
	enum power_supply_property psp, union power_supply_propval *val)
{
    ...
    case POWER_SUPPLY_PROP_CHARGING_ENABLED:
        val->intval = get_charger_manager_info()->cmd_discharging?0:1;
        break;
    case POWER_SUPPLY_PROP_CHARGE_CURRENT_NOW:
        val->intval = battery_get_bat_current()/BATTERY_CURRENT_DIVI;
        break;
    case POWER_SUPPLY_PROP_INPUT_CURRENT_NOW:
        val->intval = pmic_get_charging_current();
        break;
