...
#define GTP_PROXIMITY_ENABLE_REG                0x8042
...
#define GTP_PROXIMITY_DETECTION_EN
...
struct goodix_ts_data {
	...
	bool flip_x;
	bool flip_y;
	int support_get_tp_color;/*for tp color */
...
#define AUTO_UPGRADE_FW_NAME                "ts/dura_goodix_shenyue.img"
#define MANUAL_UPGRADE_FW_NAME                    "ts/touch_screen_firmware.img"
