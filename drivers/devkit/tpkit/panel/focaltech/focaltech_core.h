...
#define LCD_PANEL_INFO_MAX_LEN              50
#define LCD_MODULE_INFO_MAX_LEN             20
#define LCD_TXD_FT8006U_INCELL              "txd_ft8006u_5p45_hd_video_drv"

#define FTS_PROXIMITY_DETECTION_EN
...
struct fts_esdcheck_st
{
    ...
    u8      reset                : 1;    /* 1- Reset chip trigger */
    u8      unused              : 3;
...
struct focal_platform_data {
	...
	char lcd_module_name[LCD_MODULE_INFO_MAX_LEN];
};
