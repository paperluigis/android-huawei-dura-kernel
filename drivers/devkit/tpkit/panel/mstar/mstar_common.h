...
extern int mstar_ps_enable_nodata(int en, struct ts_proximity_info *info);
...
#define MSTAR_PROJECT_ID_LEN          12

#define MSTAR_PROJECT_ID_HLT          "dura292600"
#define MSTAR_FIRMWARE_NAME_HLT       "ts/dura_mstar_hlt.bin"
...
#define BK_REG8_WL(addr,val)    ( mstar_set_reg_low_byte( addr, val ) )
#define BK_REG8_WH(addr,val)    ( mstar_set_reg_hi_byte( addr, val ) )
#define BK_REG16_W(addr,val)    ( mstar_set_reg_16bit( addr, val ) )
#define BK_REG8_RL(addr)        ( mstar_get_reg_low_byte( addr ) )
#define BK_REG8_RH(addr)        ( mstar_get_reg_high_byte( addr ) )
#define BK_REG16_R(addr)        ( mstar_get_reg_16bit( addr ) )
...
extern u8 mstar_get_reg_high_byte(u16 nAddr);
extern void mstar_get_reg_xbit(u16 nAddr, u8 * pRxData, u16 nLength, u16 nMaxI2cLengthLimit);
extern s32 mstar_set_reg_16bit(u16 nAddr, u16 nData);
extern s32 mstar_set_reg_16bit_retry(u16 nAddr, u16 nData);
extern void mstar_set_reg_low_byte(u16 nAddr, u8 nData);
extern void mstar_set_reg_hi_byte(u16 nAddr, u8 nData);
extern void mstar_set_reg_16bit_on(u16 nAddr, u16 nData);
extern void mstar_set_reg_16bit_off(u16 nAddr, u16 nData);
extern u16 mstar_get_reg_16bit_by_addr(u16 nAddr, AddressMode_e eAddressMode);
extern void mstar_set_reg_16bit_by_addr(u16 nAddr, u16 nData, AddressMode_e eAddressMode);
extern void mstar_reg_mask_16bit(u16 nAddr, u16 nMask, u16 nData, AddressMode_e eAddressMode);
extern s32 mstar_dbbus_enter_serial_debug(void);
extern void mstar_dbbus_exit_serial_debug(void);
extern void mstar_dbbus_i2c_response_ack(void);
extern void mstar_dbbus_iic_use_bus(void);
extern void mstar_dbbus_iic_not_use_bus(void);
extern void mstar_dbbus_iic_reshape(void);
extern void mstar_dbbus_stop_mcu(void);
extern void mstar_dbbus_not_stop_mcu(void);
extern void mstar_dbbus_reset_slave(void);
extern void mstar_dbbus_wait_mcu(void);
extern void mstar_set_cfb(u8 Cfb);
...
extern s32 mstar_ii2c_segment_read_dbbus(u8 nRegBank, u8 nRegAddr, u8 * pBuf, u16 nSize, u16 nMaxI2cLengthLimit);
extern s32 mstar_ii2c_segment_read_smbus(u16 nAddr, u8 * pBuf, u16 nSize, u16 nMaxI2cLengthLimit);
...
extern void mstar_set_ii2c_data_rate(struct i2c_client *pClient, u32 nIicDataRate);
extern void mstar_get_customer_fw_ver(u16 * pMajor, u16 * pMinor, u8 ** ppVersion);
extern void mstar_get_customer_fw_ver_dbbus(EmemType_e eEmemType, u16 * pMajor, u16 * pMinor, u8 ** ppVersion);

extern void mstar_read_eflash_start(u16 nStartAddr, EmemType_e eEmemTypDrvIliTekReadTouchPanelInfoe);
extern void mstar_read_eflash_do_read(u16 nReadAddr, u8 * pReadData);
extern void mstar_read_eflash_end(void);
extern void mstar_reg_get_xbit_write_4byte_value(u16 nAddr, u8 * pRxData, u16 nLength, u16 nMaxI2cLengthLimit);
...
#define MSTAR_SHORT_2_TEST_PASS     "4P"
#define MSTAR_SHORT_2_TEST_FAIL     "4F"

#define ERR_ALLOC_MEM(X)    ((IS_ERR(X) || X == NULL) ? 1 : 0)

/* Structure for MP Test */
typedef struct {
    u8 allnode_test_result;
    u8 open_test_result;
...
extern int mstar_support_get_tp_color;
