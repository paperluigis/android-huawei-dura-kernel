...
#define      GC8034MIPI_SENSOR_ID          GC8034_SENSOR_ID
...
static void gc8034_read_otp_group(kal_uint8 page, kal_uint8 addr, kal_uint8 *buff, kal_uint8 size)
{
...
#ifdef GC8034OTP_FOR_CUSTOMER
static int gc8034_gcore_update_wb(void)
{
    ...
    if(gc8034_otp_info.rg_gain == 0 || gc8034_otp_info.bg_gain == 0)
        return ERROR_NONE;
...
static kal_uint32 return_sensor_id(void)
{
    ...
    if(sensor_id == GC8034_SENSOR_ID )
    {
        ...
        gc8034_gcore_enable_otp(otp_open);
        mode_id1 = gc8034_read_otp(9,0x70);
        mode_id2 = gc8034_read_otp(9,0x78);
        //LOG_INF("mode_id1 = %d\n", mode_id1);
        //LOG_INF("mode_id2 = %d\n", mode_id2);
        gc8034_gcore_enable_otp(otp_close);
        if(mode_id1 == SANYINGXING_MOD_ID  || mode_id2 == SANYINGXING_MOD_ID)//sanyingxing  0x02    sanglaishi 0x0c
        {
            sensor_id = GC8034_SENSOR_ID;
            //LOG_INF("SANYINGXING sensor_id = %d\n", sensor_id);
        }
        else
        {
            sensor_id = 0;
