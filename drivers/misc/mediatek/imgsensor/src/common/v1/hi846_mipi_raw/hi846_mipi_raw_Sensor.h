...
typedef struct HI846_otp_struct
{
    kal_uint8 Base_Info_Flag; //bit[7]:info, bit[6]:wb
    kal_uint8 module_integrator_id;
    kal_uint8 prodyction_year;
    kal_uint8 production_month;
    kal_uint8 production_day;
    kal_uint8 sensor_id;
    kal_uint8 lens_id;
    kal_uint8 vcm_id;
