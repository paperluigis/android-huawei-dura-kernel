...
static void lcm_init(void)
{
	...
	if (ret < 0)
		LCM_LOGI("holitech_ili9881c----nt50358a----cmd=%0x--i2c write error----\n", cmd);
	else
		LCM_LOGI("holitech_ili9881c----nt50358a----cmd=%0x--i2c write success----\n", cmd);
...
static void  set_lcdkit_info(void)
{
           ...
           lcdkit_info.panel_infos.model_name = "HOLITECH_ILI9881C 5.45' VIDEO TFT 720x1440";
...
LCM_DRIVER holitech_ili9881c_5p45_hd_video_lcm_drv = {
	.name = "holitech_ili9881c_5p45_hd_video_drv",
