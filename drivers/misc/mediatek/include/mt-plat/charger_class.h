...
struct charger_ops {
	...
	int (*charger_init)(struct charger_device *);
	int (*set_dpm)(struct charger_device *, unsigned char dpm);
	/* cable plug in/out */
	...
	int (*set_hz_mode)(struct charger_device *, int en);
...
extern int charger_dev_init(struct charger_device *charger_dev);
extern int charger_dev_set_dpm(struct charger_device *charger_dev, unsigned char dpmbyte);
...
extern int charger_dev_set_hz_mode(struct charger_device *charger_dev, int en);
