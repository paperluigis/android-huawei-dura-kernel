...
#include "common/GT24c32a_dura/GT24c32a_dura.h"
...
struct stCAM_CAL_FUNC_STRUCT g_camCalCMDFunc[] = {
    ...
    {CMD_GT24C32A_DURA, gt24c32a_dura_selective_read_region},
...
/*39*/
    {HI1333_SENSOR_ID, 0xA0, CMD_GT24C32A_DURA, cam_cal_check_mtk_cid},
    {OV13855_SENSOR_ID, 0xA0, CMD_GT24C32A_DURA, cam_cal_check_mtk_cid},
    {S5K3L6_SENSOR_ID, 0xA0, CMD_GT24C32A_DURA, cam_cal_check_mtk_cid},
...
unsigned int cam_cal_check_mtk_cid(struct i2c_client *client, cam_cal_cmd_func readCamCalData)
{
	...
	if (readCamCalData != NULL) {
        readCamCalData(client, 0x00, (unsigned char *)&calibrationID, 2);
