...
#define LM3643_MASK_ENABLE_LED2 (0x01)
#define LM3643_MASK_ENABLE_LED1 (0x02)
#define LM3643_DISABLE (0x00)
#define LM3643_ENABLE_LED2 (0x01)
#define LM3643_ENABLE_LED2_TORCH (0x09)
#define LM3643_ENABLE_LED2_FLASH (0x0D)
#define LM3643_ENABLE_LED1 (0x02)
#define LM3643_ENABLE_LED1_TORCH (0x0A)
#define LM3643_ENABLE_LED1_FLASH (0x0E)

#define LM3643_REG_TORCH_LEVEL_LED2 (0x05)
#define LM3643_REG_FLASH_LEVEL_LED2 (0x03)
#define LM3643_REG_TORCH_LEVEL_LED1 (0x06)
#define LM3643_REG_FLASH_LEVEL_LED1 (0x04)
