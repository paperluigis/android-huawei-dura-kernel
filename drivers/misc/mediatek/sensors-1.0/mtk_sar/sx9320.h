...
static struct smtc_reg_data sx9320_i2c_reg_setup[] = {
	 //Interrupt and config
	 {
	  ...
	  .val = 0x00,   ///0x70->78,       // Enavle Close and Far -> enable compensation interrupt
	 },
	 {
	 ...
	 //--------AFE Control
	 {
	  ...
	  .val = 0x80,  // 00->80   // CSx pin during sleep mode : HZ
	 },
	 {
	 ...
	 },
	 {
	  ...
	  .val = 0x47,   //44->47    //Sampling Freq(ph0/1) : 83.33khz(01000), Resolution(ph0/1) : 128(100)
	 },
	 {
	 ...
	 },
	 {
	  ...
	  .val =0x00,   // 0x01->00,       //big//Analog Range(ph2/3) : Small
	 },
	 {
	  .reg = SX9320_AFE_CTRL7_REG,   //0x27
	  .val = 0x47,    //44->47   //Sampling Freq(ph2/3) : 83.33khz(01000), Resolution(ph2/3) : 128(100)
	 },
	 {
	  .reg = SX9320_AFE_PH0_REG,   //0x28
	  .val = 0x00,  //0x04 ->00,       // CS2:HZ CS1:Input CS0 :HZ
	 },
	 {
	  .reg = SX9320_AFE_PH1_REG,     //0x29
	  .val = 0x01,   // 0x10->01,       // CS2:Input CS1:HZ Shield CS0 :HZ
	 },
	 {
	  .reg = SX9320_AFE_PH2_REG,   //0x2A
	  .val =0x00,    // 0x1B->04,       //CS2:HZ CS1:HZ CS0 :HZ  
	 },
	 {
	 ...
	 },
	 {
	  ...
	  .val = 0x0f,     //08->0f  // Analg gain : x1(1000)
	 },
	 //--------PROX control
	 {
	  .reg = SX9320_PROX_CTRL0_REG,  //0x30
	  .val = 0x09,   //09->0b    // Digital Gain(ph0/1) : off(001) Digital Filter(ph0/1) : 1-1/2(001)
	 },
	 {
	  .reg = SX9320_PROX_CTRL1_REG,  //0x31
	  .val = 0x0b,   //09->0b     // Digital Gain(ph2/3) : off(001) Digital Filter(ph2/3) : 1-1/2(001)
	 },
	 {
	  .reg = SX9320_PROX_CTRL2_REG,  //0x32
	  .val = 0x20,  //08->20     //AVGNEGTHRESH : 16384
	 },
	 {
	 ...
	 },
	 {
	  ...
	  .val = 0x10,    //00->10   //FARCOND: PROXDIFF < (THRESH.HYST), HYST : None, CLOSEDEB : off ,FARDEB : off
	 },
	 {
	  .reg = SX9320_PROX_CTRL6_REG,  //0x36
	  .val = 0x21,     // 0x1B->1C,       // Prox Theshold(ph0/1) : 200
	 },
	 {
	  .reg = SX9320_PROX_CTRL7_REG,  //0x37
	  .val =  0x1C,    // 0x1B->1C,       // Prox Theshold(ph2/3) : 200
	 },
	 ...
	 {
	  .reg = SX9320_ADV_CTRL2_REG,      ///  0x42
	  .val = 0x00,
	 },
	 {
	  .reg = SX9320_ADV_CTRL3_REG,       /// 0x43
	  .val = 0x20,   ////0x00-> 20,
	 },
	 {
	  .reg = SX9320_ADV_CTRL4_REG,        /// 0x44
	  .val = 0x20,    ///0x00->20,
	 },
	 {
...
#define SAR_CUST_I2C_ADDR_NUM 4
struct sar_hw {
	int i2c_num;		/*!< the i2c bus used by ALS/PS */
	unsigned char i2c_addr[SAR_CUST_I2C_ADDR_NUM];	/*!< i2c address list, some chip will have multiple address */
