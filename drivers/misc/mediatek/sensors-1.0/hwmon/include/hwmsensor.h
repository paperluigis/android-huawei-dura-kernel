...
#define SENSOR_TYPE_CAP_PROX                                        0x10005
...
#define ID_CAP_PROX                (ID_RGBW+1)//100//(ID_BASE+SENSOR_TYPE_PPG2-1+1)
/* end sensor ID */
#define ID_SENSOR_MAX_HANDLE			(ID_CAP_PROX+1)

#define ID_NONE							(ID_SENSOR_MAX_HANDLE + 1)
#define ID_OFFSET                       (1)
#define ID_SCP_MAX_SENSOR_TYPE			(70)
...
#define CAP_PL_DEV_NAME                 "m_sar_pl"
#define CAP_INPUTDEV_NAME               "m_sar_input"
#define CAP_MISC_DEV_NAME             "m_sar_misc"
...
#define EVENT_SENSOR_CAP			    SENSOR_SAR
