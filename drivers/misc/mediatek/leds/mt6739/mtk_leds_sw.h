...
enum MT65XX_PMIC_BREATH_STAGE {
	ISINK_BREATH_STAGE_TIME0 = 0,//123ms
	ISINK_BREATH_STAGE_TIME1,//338ms
	ISINK_BREATH_STAGE_TIME2//523ms
};
...
struct nled_setting {
	...
	u32 blink_on_time;
	u32 blink_off_time;
    u32 blink_raise_duration;
    u32 blink_fall_duration;
};
