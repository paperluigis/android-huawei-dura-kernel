...
#endif /* WLC_E_LAST */
#else
#define WLC_E_LAST			169	/* highest val + 1 for range checking */
#if (WLC_E_LAST > 169)
#error "WLC_E_LAST: Invalid value for last event; must be <= 168."
#endif /* WLC_E_LAST */
#endif /* WL_TEM_CTRL */
...
#define WLC_STATUS_ARP_TX_FRAME_FAIL 0x10
#define WLC_STATUS_DHCPC_TX_FRAME_FAIL 0x20
#define WLC_STATUS_8021X_TX_FRAME_FAIL 0x40
#endif
