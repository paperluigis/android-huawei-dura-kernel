...
extern ssize_t inputhub_route_read(unsigned short port, char __user *buf,
				   size_t count);
extern int inputhub_route_cmd(unsigned short port, unsigned int cmd,
			      unsigned long arg);

/*called by inputhub_mcu module or test module.*/
extern int inputhub_route_init(void);
extern void inputhub_route_exit(void);
extern ssize_t inputhub_route_write(unsigned short port, char *buf,
				    size_t count);
