...
static int pn547_get_resource(struct  pn547_dev *pdev,	struct i2c_client *client)
{
	...
	if (NFC_CLK_SRC_PMU == g_nfc_clk_src) {
		...
		hisi_pmu_reg_operate_by_bit(nfc_clk_en_reg[NFC_CLK_SRC_PMU_HI6555V200].addr,
		                            nfc_clk_en_reg[NFC_CLK_SRC_PMU_HI6555V200].pos, CLR_BIT);
		/*Register 0x0FD bit4 = 1 enable*/
		hisi_pmu_reg_operate_by_bit(nfc_clk_hd_reg[NFC_CLK_SRC_PMU_HI6555V200].addr,
									nfc_clk_hd_reg[NFC_CLK_SRC_PMU_HI6555V200].pos, SET_BIT);
	    /*Register 0x0FD bit0 = 1 enable*/
		hisi_pmu_reg_operate_by_bit(nfc_clk_xo_reg[NFC_CLK_SRC_PMU_HI6555V200].addr,
									nfc_clk_xo_reg[NFC_CLK_SRC_PMU_HI6555V200].pos, SET_BIT);
        /*Register 0x108 bit1 = 1 enable*/
		hisi_pmu_reg_operate_by_bit(nfc_clk_eco_reg[NFC_CLK_SRC_PMU_HI6555V200].addr,
									nfc_clk_eco_reg[NFC_CLK_SRC_PMU_HI6555V200].pos, SET_BIT);
		/*Register 0x1C0 bit0 = sine wave(default):1 --  square wave:0*/
		hisi_pmu_reg_operate_by_bit(nfc_clk_dig_reg[NFC_CLK_SRC_PMU_HI6555V200].addr,
									nfc_clk_dig_reg[NFC_CLK_SRC_PMU_HI6555V200].pos, SET_BIT);
		/*Register 0x0F2 bit1:bit0 = drive-strength
									00 --3pF//100K;
									01 --10pF//100K;
									10 --16pF//100K;
									11 --30pF//100K */
		hisi_pmu_reg_operate_by_bit(clk_driver_strength[NFC_CLK_SRC_PMU_HI6555V200].addr,
									clk_driver_strength[NFC_CLK_SRC_PMU_HI6555V200].pos, SET_BIT);
		hisi_pmu_reg_operate_by_bit(clk_driver_strength[NFC_CLK_SRC_PMU_HI6555V200].addr,
									clk_driver_strength[NFC_CLK_SRC_PMU_HI6555V200].pos + 1, SET_BIT);
	}
