...
struct rdr_exception_info_s s_rdr_excetion_info_for_bfmr[] = {
    {
        ...
        RDR_REENTRANT_DISALLOW, BFM_S_BOOT_TIMEOUT, 0, RDR_UPLOAD_YES, "bfm", "bfm-boot-TO",
        0, 0, 0
    },

    {
        ...
        RDR_REBOOT_NOW, RDR_AP | RDR_BFM, RDR_AP, RDR_AP,
        RDR_REENTRANT_DISALLOW, BFM_S_NATIVE_BOOT_FAIL, 0, RDR_UPLOAD_YES, "bfm", "bfm-boot-TO",
        0, 0, 0
    },

    {
        ...
        RDR_REBOOT_NOW, RDR_AP | RDR_BFM, RDR_AP, RDR_AP,
        RDR_REENTRANT_DISALLOW, BFM_S_NATIVE_DATA_FAIL, 0, RDR_UPLOAD_YES, "bfm", "bfm-boot-TO",
        0, 0, 0
    },

    {
        ...
        RDR_REBOOT_NOW, RDR_AP | RDR_BFM, RDR_AP, RDR_AP,
        RDR_REENTRANT_DISALLOW, BFM_S_FW_BOOT_FAIL, 0, RDR_UPLOAD_YES, "bfm", "bfm-boot-TO",
        0, 0, 0
    },

    {
        ...
        RDR_REENTRANT_DISALLOW, 0, 0, RDR_UPLOAD_YES, "bfm", "bfm-boot-TO",
        0, 0, 0
    },
};
