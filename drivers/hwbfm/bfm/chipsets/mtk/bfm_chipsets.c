...
#define BFM_QCOM_RAW_PART_NAME "bfr"
...
static unsigned int bfm_get_version_type(void)
{
    ...
    for (i = 0; i < BFM_QCOM_WAIT_FOR_LOG_PART_TIMEOUT; i++)
    {
...
{
    /*wait for 40S ,what about PRESS10S_FUN? SO,don't wait*/
    //unsigned int usertype = bfm_get_version_type();
    unsigned int usertype = get_logusertype_flag;
