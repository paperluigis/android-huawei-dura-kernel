...
#define LDO15_MAX_UV           (3300000)
#define LDO15_MIN_UV           (2900000)
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	int ret = 0;
        ...
        if (!strstr(saved_command_line, "androidboot.huawei_swtype=factory")) {
	...
	if (strncmp(dev_name, "vemc", strlen("vemc"))) {
