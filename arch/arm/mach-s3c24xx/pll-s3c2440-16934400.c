...
static struct cpufreq_frequency_table s3c2440_plls_169344[] = {
	...
	{ .frequency = 102135600,	.driver_data = PLLVAL(185, 6, 3), 	},
	{ .frequency = 108259200,	.driver_data = PLLVAL(171, 5, 3), 	},
	...
	{ .frequency = 126161280,	.driver_data = PLLVAL(141, 3, 3), 	},
	{ .frequency = 132088320,	.driver_data = PLLVAL(148, 3, 3), 	}, 	/* FVco 1056.706560 */
	{ .frequency = 138015360,	.driver_data = PLLVAL(155, 3, 3), 	},
	...
	{ .frequency = 156038400,	.driver_data = PLLVAL(121, 5, 2), 	},
	...
	{ .frequency = 174048000,	.driver_data = PLLVAL(177, 7, 2), 	},
	{ .frequency = 180230400,	.driver_data = PLLVAL(141, 5, 2), 	}, 	/* FVco 720.921600 */
	{ .frequency = 186278400,	.driver_data = PLLVAL(124, 4, 2), 	},
	...
	{ .frequency = 204271200,	.driver_data = PLLVAL(185, 6, 2), 	},
	{ .frequency = 210268800,	.driver_data = PLLVAL(141, 4, 2), 	},
	{ .frequency = 216518400,	.driver_data = PLLVAL(171, 5, 2), 	},
	{ .frequency = 222264000,	.driver_data = PLLVAL(97, 2, 2), 	},
	{ .frequency = 228614400,	.driver_data = PLLVAL(127, 3, 2), 	}, 	/* FVco 914.457600 */
	{ .frequency = 234259200,	.driver_data = PLLVAL(158, 4, 2), 	},
	...
	{ .frequency = 252322560,	.driver_data = PLLVAL(141, 3, 2), 	},
	...
	{ .frequency = 276030720,	.driver_data = PLLVAL(155, 3, 2), 	},
	...
	{ .frequency = 312076800,	.driver_data = PLLVAL(121, 5, 1), 	},
	...
	{ .frequency = 342074880,	.driver_data = PLLVAL(93, 3, 1), 	},
	{ .frequency = 348096000,	.driver_data = PLLVAL(177, 7, 1), 	},
	{ .frequency = 355622400,	.driver_data = PLLVAL(118, 4, 1), 	},
	...
	{ .frequency = 372556800,	.driver_data = PLLVAL(124, 4, 1), 	},
	...
	{ .frequency = 391608000,	.driver_data = PLLVAL(177, 6, 1), 	},
