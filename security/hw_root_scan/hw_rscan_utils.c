...
static int init_flag = UNINIT;
static int ro_secure_value = RO_SECURE;
				...
				ssize_t line_size)
{
	...
	new_line_len = _get_next_line(buf + (*pos),
...
/* change error return to RO_NORMAL */
