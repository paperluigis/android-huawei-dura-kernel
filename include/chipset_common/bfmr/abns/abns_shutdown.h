...
#define ABNS_LOG_ROOT_PATH     "/log/abns_shutdown"
...
#define RSV_PART_NAME_STR "/dev/block/platform/bootdevice/by-name/bfr"

#define ABNS_TYPE_CMDLINE_STR    "abns_type"
#define ABNS_SWTYPE_CMDLINE_STR  "androidboot.huawei_swtype"
#define ABNS_RUNMODE_CMDLINE_STR "androidboot.huawei_bootmode"
